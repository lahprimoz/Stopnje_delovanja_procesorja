...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\linewidth]{ARS_QRcode.png}
    \caption{Povezava do \texttt{github} repozitorija}
\end{figure}
...
\section{Izvedba}
Priporočeno minimalno število učencev za izvedbo dejavnosti je 5, lahko pa se dejavnost prilagodi glede na velikost skupine.
...
\begin{itemize}
    ...
    \item JUMP 1 - učenec programskemu števcu določi, naj se nastavi na vrednost 1, kar bo PC storil v naslednjem koraku, torej naslednji cikel se začne s PC vrednostjo 1
\end{itemize}
